...
public interface LoanApiConstants {
    ...
    public static final String LOAN_CHARGE_CAN_NOT_BE_ADDED_WITH_PRINCIPAL_OUTSTANDING_CALCULATION_TYPE = "loancharge.with.calculation.type.principal.outstanding.not.allowed";
